...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    HAZMAT("hazmat", 5, new int[] {0, 0, 0, 0}, 5, SoundEvents.ARMOR_EQUIP_LEATHER, 0f, 0f, () -> Ingredient.of(ModItems.CHARCOAL_FILTER.get()));
    ...
    public String getName() {
        return MadeForAbyss.MOD_ID + ":" + this.name;
    }
